<?php
class UpFrontSocialOptimization {
	...
	public static function init() {
		...
		add_filter('user_contactmethods', array(__CLASS__, 'add_upfront_contact_methods'));
	...
	public static function add_upfront_contact_methods($contact_methods) {

		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					...
					'Dieses Theme erfordert das folgende Plugin: %1$s.',
					'Dieses Theme erfordert die folgenden Plugins: %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					/* translators: 1: plugin name(s). */
					'Dieses Theme empfiehlt das folgende Plugin: %1$s.',
					'Dieses Theme empfiehlt die folgenden Plugins: %1$s.',
					'tgmpa'
				),
				...
				'notice_ask_to_update_maybe'      => _n_noop(
					/* translators: 1: plugin name(s). */
					'Es ist ein Update für verfügbar für: %1$s.',

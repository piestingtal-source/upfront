...
class UpFrontSchema {
	...
	public static function init() {
		...
		if(UpFrontOption::get('disable-schema-support'))
			return;

		require_once UPFRONT_LIBRARY_DIR . '/common/lib/schema-org/vendor/autoload.php';
	...
	public static function article($post){
		 ...
		 *
		 * Check dates
		 * https://www.facebook.com/groups/upfrontunlimitedEN/permalink/688903958279742/
		 */

		if( upfront_validateDate($post->post_date) )

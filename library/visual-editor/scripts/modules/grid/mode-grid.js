define(['jquery', 'modules/grid/grid', 'deps/itstylesheet', 'modules/grid/wrappers', 'modules/grid/grid-manager', 'deps/jquery.pep', 'helper.blocks', 'helper.wrappers'], function($, puGrid, wrappers) {
    ...
    var modeGrid = {
        ...
        iframeCallback: function() {
            ...
            gridStylesheet = new ITStylesheet({ document: UpFront.iframe.contents()[0], href: '/?upfront-trigger=compiler&file=ve-iframe-grid-dynamic' }, 'find');
            ...
            /* Initiate UpFront Grid */
            $i('div.wrapper').upfrontGrid();

            /* Disable Grid on mirrored wrappers */
            $i('div.wrapper-mirrored').upfrontGrid('disable');

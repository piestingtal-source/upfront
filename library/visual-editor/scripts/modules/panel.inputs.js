        ...
        delegate: function() {
            ...
            $(context).delegate('div.input-textarea span.textarea-open', 'click', function() {
                ...
                if (textareaContainer.data('visible') !== true) {
                    ...
                    UpFront.iframe.contents().bind('mousedown', { textareaContainer: textareaContainer }, textareaClose);
                    ...
                    UpFront.iframe.contents().off('mousedown', textareaClose);
            ...
            $(context).delegate('div.input-wysiwyg span.wysiwyg-open', 'click', function() {
                ...
                if (wysiwygContainer.data('visible') !== true) {
                    ...
                    UpFront.iframe.contents().bind('mousedown', { wysiwygContainer: wysiwygContainer }, wysiwygClose);
                    ...
                    UpFront.iframe.contents().off('mousedown', wysiwygClose);
            ...
            $(context).delegate('div.input-multi-select span.multi-select-open', 'click', function() {
                ...
                if (multiSelectContainer.data('visible') !== true) {
                    ...
                    UpFront.iframe.contents().bind('mousedown', { multiSelectContainer: multiSelectContainer }, multiSelectClose);
                    ...
                    UpFront.iframe.contents().off('mousedown', multiSelectClose);
            ...
            $(context).delegate('div.input-audio span.delete-audio', 'click', function() {
                ...
                if (!confirm('Möchtest Du dieses Audio wirklich entfernen?')) {
                    return false;
                }
            ...
            $(context).delegate('div.input-import-file input[type="file"]', 'change', function(event) {
                ...
                if (event.target.files[0].name.split('.').slice(-1)[0] != 'json') {
                    ...
                    $(this).val(null);
                    return alert('Ungültige UpFront-Importdatei. Stelle sicher, dass die UpFront-Importdatei eine gültige JSON-formatierte Datei ist.');
            ...
            $(context).delegate('div.input-json span.delete-json', 'click', function() {
                ...
                if (!confirm('Bist Du sicher, dass Du diesen JSON entfernen möchtest?')) {
                    return false;
                }

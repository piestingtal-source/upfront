define(['jquery', 'underscore', 'helper.contentEditor', 'deps/interact', 'util.navigation', 'deps/colorpicker', 'helper.blocks', 'modules/grid/wrappers'], function($, _, contentEditor, interact, navigation) {
    ...
    designEditorRequestElements = function(forceReload) {
        ...
        if (UpFront.elementsRequest && (!forceReload || typeof forceReload == 'undefined'))
            return UpFront.elementsRequest;

        /* Get the elements and set up bindings */
        UpFront.elementsRequest = $.post(UpFront.ajaxURL, {
            ...
            UpFront.elementGroups = $.extend({}, elements.groups);

            delete elements.groups;

            UpFront.elements = elements;
    ...
    designEditorRequestElementData = function(forceReload) {
            ...
            if (UpFront.elementDataRequest && (!forceReload || typeof forceReload == 'undefined'))
                return UpFront.elementDataRequest;

            /* Get the elements and set up bindings */
            UpFront.elementDataRequest = $.post(UpFront.ajaxURL, {
                security: UpFront.security,
                action: 'upfront_visual_editor',
                ...
                UpFront.elementData = elementData;
    ...
    designEditorTabEditor = function() {
            ...
            this.setupElementSelector = function() {
                ...
                for (const [groupID, groupInfo] of Object.entries(UpFront.elementGroups)) {
                ...
                for (const [elementID, elementSettings] of Object.entries(UpFront.elements)) {
            ...
            this.addElementStates = function(elementNode) {
                ...
                elementNode.children('.children-elements').prepend('\
							<li id="element-' + elementID + '-states" class="element element-states-container has-children">\
								<span class="element-expander"></span>\
								<span class="element-name">Zustände</span>\
								<ul class="children-elements"></ul>\
							</li>\
						');
            ...
            this.showElementProperties = function(elementNode) {
                ...
                if (_.isEmpty(UpFront.elementData[elementID])) {
                ...
                var elementProperties = UpFront.elementData[elementID];
                ...
                if (!_.isEmpty(UpFront.elementData[elementID]['properties'])) {

                    $.each(UpFront.elementData[elementID]['properties'], function(property, propertyValue) {
                ...
                $.each(specialElementTypes, function(index, specialElementType) {
                    ...
                    if (!_.isEmpty(UpFront.elementData[elementID]['special-element-' + specialElementType])) {

                        $.each(UpFront.elementData[elementID]['special-element-' + specialElementType], function(specialElementID, specialElementProperties) {
            ...
            this.addElementProperty = function(context, property, propertyValue, specialElement) {
                ...
                if (typeof UpFront.designEditorProperties[property] == 'undefined')
                    return false;

                var formattedPropertyValue;
                var propertyObject = UpFront.designEditorProperties[property];
            ...
            this.processElementMouseEnter = function(event) {
                ...
                if (!link.hasClass('element-name-has-buttons')) {
                    ...
                    elementName.find('.tooltip').qtip({
                        style: {
                            classes: 'qtip-upfront qtip-upfront-element-selector',
                            tip: false
                        },
                        position: {
                            my: 'bottom left',
            ...
            this.processElementNameLayoutSpecific = function() {
                ...
                designEditor.selectSpecialElement(elementID, 'layout', UpFront.viewModels.layoutSelector.currentLayout());
            ...
            this.processElementNameLiveCSS = function() {
                ...
                var liveCSSValue = (typeof UpFront.codeMirrorEditors['live-css'] == 'undefined' || !UpFront.codeMirrorEditors['live-css']) ? $('textarea#live-css-content').val() : decodeURIComponent(escape(window.atob(localStorage['upfront-visual-editor-live-css-content'])));
                ...
                if (typeof UpFront.codeMirrorEditors['live-css'] != 'undefined') {

                    $(UpFront.codeMirrorEditors["live-css"].window.document.getElementById("code")).val($('textarea#live-css-content').val());
                    $(UpFront.codeMirrorEditors["live-css"].window.document.getElementById("code")).focus();
            ...
            this.processElementCopy = function(event) {
                ...
                /* Get data */
                if (!_.isEmpty(UpFront.elementData[currentElement.id])) {

                    /* If it's a special element then we need to pull properties from there */
                    if (currentElement.specialElementType && !_.isEmpty(UpFront.elementData[currentElement.id]['special-element-' + currentElement.specialElementType])) {

                        if (!_.isEmpty(UpFront.elementData[currentElement.id]['special-element-' + currentElement.specialElementType][currentElement.specialElementID]))
                            var elementData = UpFront.elementData[currentElement.id]['special-element-' + currentElement.specialElementType][currentElement.specialElementID];

                        /* Otherwise looks in 'properties' for the regular elements */
                    } else if (!_.isEmpty(UpFront.elementData[currentElement.id]['properties'])) {

                        var elementData = UpFront.elementData[currentElement.id]['properties'];
                ...
                UpFront.designEditorClipboard = $.extend({}, elementData);
            ...
            this.processElementPaste = function(event) {
                ...
                if (!currentElement || typeof UpFront.designEditorClipboard == 'undefined')
                    return;
                ...
                $.each(UpFront.designEditorClipboard, function(property, value) {

                    if (typeof UpFront.designEditorProperties[property]['unit'] != 'undefined' && !isNaN(value)) {

                        if (typeof UpFront.designEditorProperties[property]['unit'] == 'string') {

                            value = value + UpFront.designEditorProperties[property]['unit'];

                        } else if (typeof UpFront.designEditorProperties[property]['unit']['default'] != 'undefined') {

                            value = value + UpFront.designEditorProperties[property]['unit']['default'];
            ...
            this.loadElementInputs = function(element, specialElementInfo) {
                ...
                return $.post(UpFront.ajaxURL, ajaxArgs).done(function(inputs) {
            ...
            this.bindDesignEditorInfo = function() {
                ...
                $('span.customize-element-for-layout').bind('click', function() {
                    ...
                    designEditor.selectSpecialElement(currentElementID, 'layout', UpFront.viewModels.layoutSelector.currentLayout());
            ...
            this.selectSpecialElement = function(elementID, specialElementType, specialElementID, propertyGroup) {
                ...
                var elementObject = designEditorGetElementObject(elementID, false);
                var specialElementName = (specialElementType != 'layout') ? elementObject[specialElementType + 's'][specialElementID].name : UpFront.viewModels.layoutSelector.currentLayoutName();
            ...
            this.switchLayout = function() {
                ...
                if (typeof UpFront.switchedToLayout == 'undefined' || !UpFront.switchedToLayout)
                    return;
    ...
    designEditorGetElementObject = function(element, excludeInstances, instanceToKeep) {
        ...
        var element = jQuery.extend(true, {}, UpFront.elements[element]);
    ...
    designEditorInputColor = function(event) {
            ...
            $(this).colorpicker({
                ...
                allowNull: false,
                showAnim: false,
                swatches: (typeof UpFront.colorpickerSwatches == 'object' && UpFront.colorpickerSwatches.length) ? UpFront.colorpickerSwatches : true,
                color: inputVal,
    ...
    propertyInputCallbackAnimationRules = function(params, block) {
        ...
        var content = $.ajax(UpFront.ajaxURL, {
            async: false,
            cache: false,
            type: 'POST',
            dataType: 'text',
    ...
    addInspector = function(refresh) {
        ...
        if (typeof UpFront.elements == 'undefined') {
            return $.when(designEditorRequestElements()).then(addInspector);
        }

        $.each(UpFront.elements, function(elementID, elementSettings) {
        ...
        if (typeof refresh == 'undefined' || refresh !== true) {
            ...
            $i('body').qtip({
                id: '',
                style: {
                    classes: 'qtip-upfront qtip-inspector-tooltip'
                },
                position: {
                    target: 'mouse',
                    my: 'bottom left',
                    at: 'top right',
                    container: $i('body'),
                    viewport: $i('#upfront-tooltip-container'),
                    effect: false,
                    adjust: {
                        x: 0,
                        y: 0,
                ...
                content: {
                    text: 'Bewege den Mauszeiger über ein Element.'
                },
                show: {
                    event: false,
                    ready: true
    ...
    enableInspector = function() {
        ...
        if (UpFront.mode != 'design' || !UpFront.designEditorSupport) {
            return false;
        }

        UpFront.inspectorDisabled = false;
        UpFront.disableBlockDimensions = true;
        ...
        var inspectorMouseMoveEvent = !UpFront.touch ? 'mousemove' : 'touchstart';
        ...
        UpFront.iframe.contents().find('body').bind('keydown', inspectorNudging);
        UpFront.iframe.bind('keydown', inspectorNudging);

        /* Focus iframe on mouseover */
        UpFront.iframe.bind('mouseover', function() {
            UpFront.iframe.focus();
        });

        showNotification({
            id: 'inspector',
            message: '<strong>Rechtsklick</strong> hervorgehobene Elemente, um sie zu stylen.<br /><br />Sobald ein Element ausgewählt ist, kannst Du es mit den Pfeiltasten verschieben.<br /><br />Das verblasste Orange und Lila sind die Ränder und die Polsterung. Diese Farben sind nur sichtbar, wenn der Inspektor aktiv ist.',
            closeConfirmMessage: 'Stelle sicher, dass Du die Funktionsweise des Design Editor-Inspektors verstanden hast, bevor Du diese Meldung ausblendest.',
            closeTimer: false,
            closable: true,
            doNotShowAgain: true
        });
    ...
    disableInspector = function() {
        ...
        UpFront.inspectorDisabled = true;

        delete UpFront.disableBlockDimensions;
        delete inspectorElement;
        ...
        UpFront.iframe.contents().find('body').off('keydown', inspectorNudging);
        UpFront.iframe.off('keydown', inspectorNudging);
    ...
    updateInspectorVisibleBoxModal = function() {
            ...
            if (typeof UpFront.inspectorDisabled != 'undefined' && UpFront.inspectorDisabled)
                return;
                ...
                if (typeof inspectorElementOptions == 'object') {
                    ...
                    if (typeof inspectorElementOptions.instance != 'undefined') {
                        ...
                        if (inspectorElementOptions.name.indexOf(' &ndash; ') !== -1) {
                            ...
                            insideInstanceText = '<span class="inspector-tooltip-instance">Innerhalb <strong>' + inspectorElementOptions.name.split(' &ndash; ')[0] + '</strong></span>';
                    ...
                    tooltipText += '<small class="right-click-message">Rechtsklick zum stylen</small>';
    ...
    inspectorContextMenuItemClick = function(contextMenu, originalRightClickEvent) {
        ...
        if ($(this).parents('li').first().hasClass('inspector-context-menu-block-options')) {
            ...
            if (blockType == 'content') {
                ...
                showNotification({
                    id: 'no-supported',
                    message: 'Der Inhaltseditor unterstützt derzeit nur den Inhalts- und PinBoard-Block.',
                    closeTimer: 3000
                });
            ...
            if ($(this).parents('li').first().hasClass('inspector-context-menu-edit-for-layout')) {
                ...
                designEditor.selectSpecialElement(inspectorElementOptions['id'], 'layout', UpFront.viewModels.layoutSelector.currentLayout());
    ...
    inspectorContextMenuContents = function(event) {
            ...
            if (isInstance) {
                ...
                // Edit This Instance
                contextMenu.append('<li class="inspector-context-menu-edit-instance" data-instance-id="' + inspectorElementOptions.instance + '"><span>Bearbeite diese Instanz</span></li>');

                //Edit content option							
                contextMenu.append('<li class="inspector-context-menu-edit-content" data-instance-id="' + inspectorElementOptions.instance + '"><span>Inhalt bearbeiten</span></li>');


                var regularElementGroup = $('<li class="inspector-context-menu-edit-normal"><span class="group-title group-title-clickable">Reguläres Element bearbeiten<small>' + inspectorElementOptions.parentName + '</small></span><ul></ul></li>').appendTo(contextMenu);
                regularElementGroup = regularElementGroup.find('ul').first();

                /* Regular Element */
            } else {

                regularElementGroup.append('<li class="inspector-context-menu-edit-normal"><span>Bearbeiten</span></li>');

            }

            regularElementGroup.append('<li class="inspector-context-menu-edit-for-layout"><span>Für dieses Layout bearbeiten</span></li>');
            ...
            if (!_.isEmpty(inspectorElementOptions.states)) {
                ...
                $.each(inspectorElementOptions.states, function(stateID, stateInfo) {
                    statesMenu.find('ul').append('<li data-state-id="' + stateID + '"><span>Bearbeite ' + stateInfo.name + '</span></li>');
                });
            ...
            if (!_.isEmpty(inspectorElementOptions.instances)) {
                ...
                if (typeof inspectorElementOptions.instance == 'undefined' || !inspectorElementOptions.instance) {
                    var instancesMenu = $('<li class="inspector-context-menu-instances"><span class="group-title">Instanzen</span><ul></ul></li>').appendTo(contextMenu);
                } else {
                ...
                $.each(inspectorElementOptions.instances, function(instanceID, instance) {
                    ...
                    if (instance['state-of'] == inspectorElementOptions.instance) {
                        ...
                        if (!contextMenu.find('> li.inspector-context-menu-instance-states').length)
                            $('<li class="inspector-context-menu-instance-states"><span class="group-title">Instanzzustände</span><ul></ul></li>')
            ...
            if (inspectorElement.parents('.inspector-element').length) {
                ...
                var parentsMenu = $('<li class="inspector-context-menu-parents"><span class="group-title">Eltern</span><ul></ul></li>').appendTo(contextMenu);
            ...
            if (getBlock(inspectorElement)) {
                ...
                var blockOptionsNode = $('<li class="inspector-context-menu-block-options"><span>Blockoptionen öffnen</span></li>').appendTo(contextMenu);
    ...
    getSelectedElement = function() {
        ...
        if (typeof UpFront.designEditorCurrentElement != 'undefined')
            return UpFront.designEditorCurrentElement;
    ...
    setSelectedElement = function(element) {
        ...
        UpFront.designEditorCurrentElement = element;
    ...
    var modeDesign = {
        ...
        init: function() {
            ...
            try {
                ...
                $.getScript(UpFront.upfrontURL + '/library/visual-editor/' + UpFront.scriptFolder + '/util.fonts-browser.js');

                /* Load Google API */
                //$.getScript('//ajax.googleapis.com/ajax/libs/webfont/1.4.7/webfont.js');
                $.getScript(UpFront.upfrontURL + '/library/visual-editor/' + UpFront.scriptFolder + '/deps/webfont-1.4.7.js');

<?php
class UpFrontIframeDummyContent {
    ...
    public static function get_entry_content($post_type_text = 'entry') {
        ...
        return <<<HTML
<p><strong>Dies ist Beispielinhalt von UpFront</strong> um Dir eine Vorstellung davon zu geben, wie ein <em>Single $post_type_text</em> aussehen wird.</p>
...
HTML;
    ...
    public static function inject_wp_query() {
        ...
        $layout_fragments = explode(UpFrontLayout::$sep, UpFrontLayout::get_current());
